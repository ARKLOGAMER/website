		...
		<div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 lg:flex lg:justify-between">
			...
			<div class="relative h-16 flex lg:max-w-lg lg:w-full">
				<div class="relative z-10 flex items-center lg:hidden">
					...
					>
						<heroicons-outline-sun v-if="!darkMode" class="fill-current text-gray-200 hover:text-white h-6 w-6" />
						<heroicons-outline-moon v-else class="fill-current text-gray-200 hover:text-white h-6 w-6" />
					</button>
				</div>
				...
				<div class="relative z-10 flex items-center lg:hidden">
					...
					>
						...
						<heroicons-outline-menu :class="{ hidden: open, block: !open }" aria-hidden="true" />
						<heroicons-outline-x :class="{ block: open, hidden: !open }" aria-hidden="true" />
					</button>
				</div>
			</div>
		</div>

		<nav v-if="open" id="mobile-menu" class="lg:hidden" aria-label="Global navigation">
